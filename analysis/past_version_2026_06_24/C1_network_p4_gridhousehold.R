...
pop_files <- c(
  "output/popdata/case1_1M_pop.rds",
  "output/popdata/case2_Ituri_pop.rds",
  "output/popdata/case3_Kivu_pop.rds"
)
pop_files <- pop_files[file.exists(pop_files)]
message(sprintf("  Case files found: %d / 3", length(pop_files)))
