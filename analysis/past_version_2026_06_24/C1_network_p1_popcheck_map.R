...
dir.create("figure/network/DRC_1km/C1_p1", showWarnings = FALSE, recursive = TRUE)

ggsave("figure/network/DRC_1km/C1_p1/drc_map.png",
       plot = p_drc, width = 10, height = 10, dpi = 500)
message("  Saved: figure/C1_p1/drc_map.png")

ggsave("figure/network/DRC_1km/C1_p1/nordkivu_map.png",
